...
from data.loaders import mc_loader
...
def train(args, model, optimizer, writer):
    ...
    (train_loader, train_dataset, test_loader, test_dataset, _, _) = mc_loader(args, num_workers=args.num_workers)
...
def main():
    parser = argparse.ArgumentParser(description='MC experiment.')
    parser.add_argument('--out_dir', type=str, default="./result/mc")
    parser.add_argument('--experiment', type=str, default="mc")
    ...
    # General
    parser.add_argument('--genc_input', type=int, default=182)
    parser.add_argument('--seed', type=int, default=22)
    parser.add_argument('--num_epochs', type=int, default=10)
    parser.add_argument('--batch_size', type=int, default=10)
    parser.add_argument('--data_input_dir', type=str, default="/home/rmmeng/data/neural/mc_maze_nerual_spikes_smth_50_vs_handvel_cond0.pickle")
    ...
    parser.add_argument('--model_path', type=str, default="./result/mc")
