...
from data.loaders import m1_loader
from utils.utils_prediction import linear_decode_r2


def encode_test(args, model):
    (train_loader, train_dataset, test_loader, test_dataset, Y_train, Y_test) = m1_loader(args, num_workers=args.num_workers)
    ...
    X_test_cpc, _ = model.model.get_latent_representations(
        torch.from_numpy(test_dataset.get_full_data()[None,:,:]).float().to(args.device))
...
def main():
    parser = argparse.ArgumentParser(description='M1 experiment.')
    parser.add_argument('--out_dir', type=str, default="./result/m1")
    parser.add_argument('--experiment', type=str, default="m1")
    ...
    # General
    parser.add_argument('--genc_input', type=int, default=109)
    parser.add_argument('--seed', type=int, default=22)
    parser.add_argument('--num_epochs', type=int, default=10)
    parser.add_argument('--batch_size', type=int, default=10)
    parser.add_argument('--data_input_dir', type=str, default="/home/rui/Data/M1/indy_20160627_01.mat")
    ...
    parser.add_argument('--model_path', type=str, default="./result/m1")
