...
from data.loaders import ms_loader
from utils.utils_prediction import linear_decode_r2


def encode_test(args, model):
    (train_loader, train_dataset, test_loader, test_dataset, Y_train, Y_test) = ms_loader(args,
...
def main():
    ...
    parser.add_argument('--out_dir', type=str, default="./result/ms")
    parser.add_argument('--experiment', type=str, default="ms")
    ...
    # General
    parser.add_argument('--genc_input', type=int, default=12)
    parser.add_argument('--seed', type=int, default=22)
    parser.add_argument('--num_epochs', type=int, default=10)
    parser.add_argument('--batch_size', type=int, default=10)
    parser.add_argument('--data_input_dir', type=str, default="/home/rui/Data/motion_sense/A_DeviceMotion_data/std_6/sub_19.csv")
    ...
    parser.add_argument('--model_path', type=str, default="./result/ms")
